...
<section class="about-layout1 space">
    ...
    <span class="shape-mockup z-index-n1" style="right: 0; top: 0px;"><img src="{{ asset('/frontend/assets/img/shapes/about-shape-1-2.png') }}" alt="counter element"></span>
</section>
<!-- About Area End -->
<!-- Client Area  -->
...
<section class="vs-team__layout1 bg-linear space">
    ...
    <span class="shape-mockup z-index-n1" style="left: 0; bottom: 0px;"><img src="{{ asset('/frontend/assets/img/shapes/team-shep1.png') }}" alt="team element"></span>
</section>
<!-- Team Area End -->
@endsection