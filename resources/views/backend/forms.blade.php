    ...
    <section class="row g-3">
      <div class="col-12 col-xl-7">
        <form class="panel needs-validation" novalidate>
          ...
          <div class="row g-3">
            <div class="col-md-6"><label class="form-label" for="formName">Full name</label><input class="form-control" id="formName" required>
              <div class="invalid-feedback">Full name is required.</div>
            </div>
            <div class="col-md-6"><label class="form-label" for="formEmail">Email</label><input class="form-control" id="formEmail" type="email" required>
              <div class="invalid-feedback">Valid email is required.</div>
            </div>
            <div class="col-md-6"><label class="form-label" for="formPlan">Plan</label><select class="form-select" id="formPlan" required>
            ...
            <div class="col-md-6"><label class="form-label" for="formBudget">Budget</label><input class="form-control" id="formBudget" type="number" min="1" required>
              <div class="invalid-feedback">Enter a valid budget.</div>
            </div>
            <div class="col-12"><label class="form-label" for="formMessage">Message</label><textarea class="form-control" id="formMessage" rows="5" required></textarea>
