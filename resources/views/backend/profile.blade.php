      ...
      <div class="col-12 col-xl-8">
        <form class="panel needs-validation" novalidate>
          ...
          <div class="row g-3">
            ...
            <div class="col-12"><label class="form-label" for="profileBio">Bio</label><textarea class="form-control" id="profileBio" rows="5">Focused on clean admin workflows, reusable UI systems, and reliable operations.</textarea></div>
          </div>
