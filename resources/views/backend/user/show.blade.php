            ...
            <div class="col-12 col-xl-4">
                <div class="panel h-100 text-center profile-card">
                    ...
                    <div class="profile-hero">
                        <img class="avatar-img avatar-xl profile-photo" src="{{ $user->user_image ? (filter_var($user->user_image, FILTER_VALIDATE_URL) ?$user->user_image : asset('storage/'.$user->user_image)) :asset('no-user.jpg') }}" alt="{{ $user->name }}">
